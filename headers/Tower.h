...
public:
    ...
    static bool enemy_in_range(const Enemy& enemy, double radius, SDL_Point center);
...
protected:
    ...
    std::unique_ptr<UpgradeButton> mUpgrade_damage_button;
    std::unique_ptr<UpgradeButton> mUpgrade_range_button;
    std::unique_ptr<UpgradeButton> mUpgrade_attackspeed_button;

    std::shared_ptr<Text> mDamage_upgrade_number_texture;
    std::shared_ptr<Text> mAttackspeed_upgrade_number_texture;
    std::shared_ptr<Text> mRange_upgrade_number_texture;
    std::shared_ptr<Text> mDmg_value;
    std::shared_ptr<Text> mAs_value;
    std::shared_ptr<Text> mRange_value;
    std::shared_ptr<Text> mDamage_distribution_value;
    std::shared_ptr<Text> mExplosive_radius_value;
};
